...
tag = NOW_TIME
name = "UIFV2ray 下载页面"
upload_file = BASE_DIR + '/runtime/linux_x64.zip'
...
UploadFile(new_release_id, BASE_DIR + '/runtime/mac_x64.zip')
UploadFile(new_release_id, BASE_DIR + '/runtime/windows_x64.zip')
